...
def incremental_load():
    refresh_file = pd.read_csv(Path(__file__).resolve().parent / "time_tracker" / "refresh_file.csv")
    ...
    refresh_file.to_csv(Path(__file__).resolve().parent / "time_tracker" / "refresh_file.csv", index=False)
