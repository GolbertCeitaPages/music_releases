...
DEEZER_ALL = id_file["playlist_id"][id_file["platform"].str.lower().str.strip() == "deezer"].to_list()
SPOTIFY_ALL = id_file["playlist_id"][id_file["platform"].str.lower().str.strip() == "spotify"].to_list()
